...
int main(void)
{
  ...
  if(GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_14)){
    ...
    LCD_ShowString(0,0,"JTAG is Unlock");
  }else{
    
    Set_Pen_Color(LCD_red);
    LCD_ShowString(0,0,"JTAG is Lock");
    ...
    output push-pull */
    GPIO_Init_s.GPIO_Pin = GPIO_Pin_13 | GPIO_Pin_14 | GPIO_Pin_15;
    GPIO_Init_s.GPIO_Mode = GPIO_Mode_OUT;
    GPIO_Init_s.GPIO_OType = GPIO_OType_PP;
    ...
    GPIO_Init_s.GPIO_Pin = GPIO_Pin_3 | GPIO_Pin_4;
