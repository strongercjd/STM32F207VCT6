...
#define PHY_SR    ((uint16_t)16) /* Value for RTL8201EL PHY */
...
#define PHY_SPEED_STATUS            ((uint16_t)0x0002) /* Value for RTL8201EL PHY */
#define PHY_DUPLEX_STATUS           ((uint16_t)0x0004) /* Value for RTL8201EL PHY */
